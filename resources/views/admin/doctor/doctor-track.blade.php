...
@section('title', 'Dokter Tracks Detail')
        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Dokter Track Detail</h4>
                            <a href="{{ route('doctor.index') }}" class="btn btn-outline-info"><i class="fa-solid fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                            @if (session('message'))
                            ...
                            <div class="table-responsive">
                                ...
                                <h4>Discussion : </h4>
                                @if ($discussion == '[]')
                                <h6 class="mb-4">Belum Ada Diskusi Yang Dibuat Dokter Ini</h6>
                                @else
                                ...
                                <h4>Response : </h4>
                                @if ($response == '[]')
                                <h6 class="mb-4">Belum Ada Response Yang Dibuat Dokter Ini</h6>
                                @else
